...
{
    if (m_pictureEdit) {
        m_pictureEdit->deleteLater();
        m_pictureEdit = nullptr;
    }
...
void WidgetHead::mousePressEvent(QMouseEvent *e)
{
    ...
    {
        SltPictureCutClose();//删掉旧的
        m_pictureEdit=new PictureEdit();
        connect(m_pictureEdit,&PictureEdit::signalClose,this,&WidgetHead::SltPictureCutClose);
        connect(m_pictureEdit,&PictureEdit::signalCutHeadOk,this,SltChangeNewPixHead);
